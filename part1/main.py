...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    train_y_mod3, test_y_mod3 = update_y(
        train_y,
        test_y
    )
    ...
    print(
        'softmax test_error_mod3 using current model =',
        test_error_mod3
    )
...
theta_pca, cost_function_history_pca = softmax_regression(
    train_pca,
    train_y,
    temp_parameter=1,
    alpha=0.3,
...
n_components_cube = 10

train_pca10 = project_onto_PC(
    train_x,
    pcs,
    n_components_cube,
    feature_means
...
theta_cube, cost_function_history_cube = softmax_regression(
    train_cube,
    train_y,
    temp_parameter=1,
    alpha=0.3,
...
print(
    'Cubic feature Softmax test_error =',
    test_error_cube
)